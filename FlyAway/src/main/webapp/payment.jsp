			...
			<div class="third-row">
				...
				<div class="selection">
					<div class="date">
						...
						</select> <select name="years" id="years">
					...
					<div class="cards">
						<img src="image/mc.png" alt=""> <img src="image/vi.png"
							alt=""> <img src="image/pp.png" alt="">
					</div>
				</div>
			</div>
			<a class="payA" href="confirmation.jsp">Confirm</a>
		</div>
	</div>	
</body>
</html>