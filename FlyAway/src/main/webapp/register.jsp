...
<body style="background-image: url('image/regpic.jpg');background-size: cover;">
							...
							<form action="RegisterServlet" method="post">
								...
								<div class="form-group">
									<label for="phone">User phone</label> <input type="number"
										class="form-control" id="number" name="phone"
										placeholder="Enter number">
								</div>
								<div class="form-group">
									<label for="address">User Age</label>
									<input type="number" class="form-control"
										name="age" placeholder="enter your age here" />
								</div>
								...
								<div class="container text-center">
									<button type="submit" class="btn btn btn-dark"
										style="color: green; background-color: #C7CCCD">Register</button>
